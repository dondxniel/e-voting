...
router.post("/vote", async (req, res) => {
    ...
    let first4 = splittedPhoneNumber[0] + splittedPhoneNumber[1] + splittedPhoneNumber[2] + splittedPhoneNumber[3];
    response = `${e} ${phoneNumber}`;
    /*
        if (recognizedNumberFormats.includes(first4)) {
